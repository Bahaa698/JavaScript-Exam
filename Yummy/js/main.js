let sideBarInnerLoop = $(".sideBar-inner").innerWidth();
...
function closeSideBar() {
  $("#sideBar").animate({ left: -sideBarInnerLoop }, 500);
  $(".open-close-icon").addClass("fa-align-justify");
  $(".open-close-icon").removeClass("fa-x");
  $(".sideBar-header li").animate({ top: 300 }, 500);
}
$(document).ready(function () {
  searchByName("").then(() => {
    $(".overlay-layer").fadeOut(10, function () {
      $("#loading-screen").fadeOut(10, function () {
  ...
  $("#sideBar").css("left", -sideBarInnerLoop);
...
let myRowData = document.getElementById("myRowData");
...
function displayContacts() {
  myRowData.innerHTML = `<div class="contact min-vh-100 d-flex justify-content-center align-items-center">
